...
export default function TeacherHomeworkBox() {
    ...
    const renderHomework = ({ item }) => (
      ...
      >
        <View style={styles.cardRow}>
          ...
          <Text style={styles.teacherText}>👨‍🏫 {item.studentName}</Text>
        </View>
            ...
            <View style={styles.modalContent}>
              {selectedHomework && (
                <>
                  ...
                  <Text style={styles.modalInfo}>👨‍🏫 Öğrenci: {selectedHomework.studentName}</Text>
